                                        ...
                                        <div class="col-sm">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select @error('pendidikan_ibu') is-invalid @enderror" name="pendidikan_ibu">
                                                    <option value="D3" {{ $data_pasien->pendidikan_ibu == 'D3' ? 'selected' : '' }}>D3</option>
                                                    <option value="S1" {{ $data_pasien->pendidikan_ibu == 'S1' ? 'selected' : '' }}>S1</option>
                                                    <option value="S2" {{ $data_pasien->pendidikan_ibu == 'S2' ? 'selected' : '' }}>S2</option>
                                                    <option value="S3" {{ $data_pasien->pendidikan_ibu == 'S3' ? 'selected' : '' }}>S3</option>
                                                    </option>
                                                </select>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select @error('pekerjaan_ibu') is-invalid @enderror" name="pekerjaan_ibu">
                                                    ...
                                                    <option value="TidakBekerja" {{ $data_pasien->pekerjaan_ibu == 'TidakBekerja' ? 'selected' : '' }}>TidakBekerja</option>
                                                    </option>
                                                </select>
                                                @error('pekerjaan_ibu')
                                                    <span class="invalid-feedback" role="alert">
